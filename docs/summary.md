...
By default, the game starts with a one-stone grid. After each completed level, the side of the grid grows by one. (However, automatic growth can be disabled in the game settings.)
