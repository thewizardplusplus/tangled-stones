...
По умолчанию на первом уровне находится один камень. После каждого пройденного уровня количество камней вдоль каждой стороны сетки увеличивается на единицу, но не более чем до 20. Текущий размер сетки сохраняется и восстанавливается при следующем запуске игры.
